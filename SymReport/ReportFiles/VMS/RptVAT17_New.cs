...
namespace SymReport.ReportFiles.VMS {
    ...
    public class RptVAT17_New : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "SymReport.ReportFiles.VMS.RptVAT17_New.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptVAT17_New : Component, ICachedReport {
        
        public CachedRptVAT17_New() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptVAT17_New rpt = new RptVAT17_New();
            rpt.Site = this.Site;
            return rpt;
        }
