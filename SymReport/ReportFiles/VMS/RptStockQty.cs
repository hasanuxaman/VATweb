...
namespace SymReport.ReportFiles.VMS {
    ...
    public class RptStockQty : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "SymReport.ReportFiles.VMS.RptStockQty.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptStockQty : Component, ICachedReport {
        
        public CachedRptStockQty() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptStockQty rpt = new RptStockQty();
            rpt.Site = this.Site;
            return rpt;
        }
