...
namespace SymReport.ReportFiles.VMS {
    ...
    public class RptVAT18_New : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "SymReport.ReportFiles.VMS.RptVAT18_New.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptVAT18_New : Component, ICachedReport {
        
        public CachedRptVAT18_New() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptVAT18_New rpt = new RptVAT18_New();
            rpt.Site = this.Site;
            return rpt;
        }
