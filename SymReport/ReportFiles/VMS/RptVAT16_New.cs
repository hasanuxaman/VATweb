...
namespace SymReport.ReportFiles.VMS {
    ...
    public class RptVAT16_New : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "SymReport.ReportFiles.VMS.RptVAT16_New.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptVAT16_New : Component, ICachedReport {
        
        public CachedRptVAT16_New() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptVAT16_New rpt = new RptVAT16_New();
            rpt.Site = this.Site;
            return rpt;
        }
