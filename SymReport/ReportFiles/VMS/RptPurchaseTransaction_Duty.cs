...
namespace SymReport.ReportFiles.VMS {
    ...
    public class RptPurchaseTransaction_Duty : ReportClass {
        
        public RptPurchaseTransaction_Duty() {
        }
        
        public override string ResourceName {
            get {
                return "RptPurchaseTransaction_Duty.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymReport.ReportFiles.VMS.RptPurchaseTransaction_Duty.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptPurchaseTransaction_Duty : Component, ICachedReport {
        
        public CachedRptPurchaseTransaction_Duty() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptPurchaseTransaction_Duty rpt = new RptPurchaseTransaction_Duty();
            rpt.Site = this.Site;
            return rpt;
        }
