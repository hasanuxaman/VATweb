...
{
    public class PurchaseBolloreController : ApiController
    {

        private AuthHelper _authHelper = new AuthHelper();

        [HttpPost]
        public HttpResponseMessage SavePurchaseBollore(PurchaseAPIVM_Bollore vm, [FromUri]string BIN)
        {

            FileLogger.Log("BolloreAPI", "SavePurchaseBollore", "Data Received. BIN Number : " + BIN + " ");
            ...
            try
            {
                ...
                PurchaseInvoiceRepo api = new PurchaseInvoiceRepo();

                rVM = api.ImportPurchaseBollore(xmlData);
                ...
                if (flag == "Y")
                {
                    FileLogger.LogRegularSale("Purchase", "SavePurchaseBollore", xmlData, "Purchase" + rVM.FileName);
                }
                ...
                var response = new HttpResponseMessage() { Content = new StringContent(jsonString), StatusCode = HttpStatusCode.OK };
            ...
            catch (Exception e)
            {
                ...
                string xml = PurchaseResponse_Bollore("Fail", e.Message);
            ...
            {
               // SendPurchaseResponse(rVM.XML2, vm, rVM.FileName);
            }
        }
        ...
        private string PurchaseResponse_Bollore(string Status, String Message)
        {
        ...
        public string SendPurchaseResponse(string Xml, PurchaseAPIVM_Bollore vm, string FileName)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    evm.SourceName = "PurchaseResponseAPI";
                    evm.ActionName = "SendPurchaseResponse";
            ...
            catch (Exception e)
            {
                try
                {
                    ...
                    evm.ErrorDate = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
                    evm.SourceName = "PurchaseResponseAPIException";
                    evm.ActionName = "SendPurchaseResponse";
                    evm.TransactionName = "Purchase";
