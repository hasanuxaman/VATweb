...
{
    [ShampanAuthorize]
    public class MPLBDBankInformationController : Controller
    {
        ShampanIdentity identity = null;

        MPLBDBankInformationRepo _repo = null;

        public MPLBDBankInformationController()
        {
            try
            {
                identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
                _repo = new MPLBDBankInformationRepo(identity);
            }
            catch
            {
        ...
        {
            identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
            _repo = new MPLBDBankInformationRepo(identity, Session);
        ...
        {
            var vm = new MPLBDBankInformationRepo(identity, Session).SelectAll(Convert.ToInt32(ItemId)).FirstOrDefault();
