...
namespace SymVATWebUI.Areas.Common.Controllers
{
    ...
    public class AssetController : Controller
    {
        ...
        public ActionResult _index(JQueryDataTableParamModel param)
        {
            ...
            IEnumerable<AssetVM> filteredData;
            ...
            Func<AssetVM, string> orderingFunction = (c =>
        ...
        [Authorize(Roles = "Master,Admin,Account")]
        [HttpPost]
        public ActionResult Create(AssetVM vm)
        {
        ...
        [Authorize(Roles = "Master,Admin,Account")]
        [HttpPost]
        public ActionResult Edit(AssetVM vm, string btn)
        {
            string[] result = new string[6];
            ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        ...
        [Authorize(Roles = "Master,Admin,Account")]
        public JsonResult AssetDelete(string ids)
        {
            AssetVM vm = new AssetVM();
