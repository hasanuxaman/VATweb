...
namespace SymServices.Common
{
    public class CommonDAL
    {
        ...
        #endregion
        public System.Data.DataTable SearchTransanctionHistoryNew(string TransactionNo, string TransactionType, string TransactionDateFrom, string TransactionDateTo, string ProductName, string databaseName)
        {
            #region Variables
...
FROM SuperAdministrator";
        ...
        public string settings(string SettingGroup, string SettingName)
        {
            ...
            try
            {
                ...
                sqlText += " WHERE SettingGroup='" + SettingGroup + "' AND SettingName='" + SettingName + "' AND UserId='" + SymOrdinary.UserInfoVM.UserId + "'";
                ...
                {
                    DataRow[] settingRow =
                    SymViewModel.Common.settingVM.SettingsDT.Select("SettingGroup='" + SettingGroup + "' and SettingName='" + SettingName +
                                                "'");
        ...
        public string SysDBCreate(string Uname, string Pwd, string DBSource)
        {
            ...
            SymOrdinary.SysDBInfoVM.SysDatabaseName = "SymphonyVATSys";
        ...
        public string[] SuperAdministratorUpdate(string miki, string mouse)
        {
            ...
            try
            {
                ...
                if (transaction == null) { transaction = currConn.BeginTransaction("SA"); }
                #endregion open connection and transaction
        ...
        public bool UpdateSystemData(string userName, string password, string source)
        {
            ...
            try
            {
                ...
                if (transaction == null) { transaction = currConn.BeginTransaction("sysdb"); }
                #endregion open connection and transaction
        ...
        public List<string> SelectFieldsByConditionList(string tableName, List<string> selectFields, List<string> conditionFields = null, List<string> conditionValues = null, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
            ...
            try
            {
                ...
                if (conditionFields != null && conditionValues != null)
                {
                    ...
                    {
                        if (string.IsNullOrWhiteSpace(conditionFields[i]) && conditionFields.Count() == conditionValues.Count())
                        {
                            continue;
                        }
                ...
                i = 0;
                if (conditionFields != null && conditionValues != null && conditionFields.Count() == conditionValues.Count())
                {
                    foreach (string item in conditionFields)
                    {
        ...
        public string[] SelectFieldsByCondition(string tableName, string[] selectFields, string[] conditionFields = null, string[] conditionValues = null, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
            ...
            try
            {
                ...
                if (conditionFields != null && conditionValues != null)
                {
                    foreach (string item in conditionFields)
                    {
                        if (string.IsNullOrWhiteSpace(conditionFields[i]) && conditionFields.Length == conditionValues.Length)
                        {
                            continue;
                        }
                        sqlText += " AND " + conditionFields[i] + "=@" + conditionFields[i];
        ...
        ////==================SelectByCondition=================
        public DataTable SelectByCondition(string tableName, string conditionField, string conditionValue, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
        ...
        public DataTable SelectByMultiCondition(string tableName, string[] conditionFields, string[] conditionValues, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
        ...
        public bool ExistCheck(string tableName, string[] conditionFields, string[] conditionValues, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
            #region Variables
            bool Exist = false;
            SqlConnection currConn = null;
        ...
        public bool ExistCheckOnUpdate(string tableName, string Id, string[] conditionFields, string[] conditionValues, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
            #region Variables
            bool Exist = false;
            SqlConnection currConn = null;
        ...
        public bool ExistCheck(string tableName, string conditionField, string conditionValue, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
            #region Variables
            bool Exist = false;
            SqlConnection currConn = null;
        ...
        /// <returns></returns>
        public bool CheckDuplicateInInsertUser(string tableName, string fieldName, string value, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
            #region Variables
            bool Exist = false;
            SqlConnection currConn = null;
            ...
            try
            {
                ...
                #endregion open connection and transaction
                #region sql statement
                sqlText = @" SELECT top 1 " + fieldName + " from " + tableName + " where " + fieldName + "= '" + value + "' and IsArchived=0";
                SqlCommand _objComm = new SqlCommand();
                _objComm.Connection = currConn;
                _objComm.CommandText = sqlText;
                _objComm.CommandType = CommandType.Text;
        ...
        public bool CheckDuplicateInInsert(string tableName, string fieldName, string value, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
            #region Variables
            bool Exist = false;
            SqlConnection currConn = null;
            ...
            try
            {
                ...
                #endregion open connection and transaction
                #region sql statement
                sqlText = @" SELECT top 1 " + fieldName + " from " + tableName + " where " + fieldName + "= '" + value + "' and IsArchive=0";
                SqlCommand _objComm = new SqlCommand();
                _objComm.Connection = currConn;
                _objComm.CommandText = sqlText;
                _objComm.CommandType = CommandType.Text;
        ...
        public bool CheckDuplicateInInsertWithBranch(string tableName, string fieldName, string value, int branchId, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
            #region Variables
            bool Exist = false;
            SqlConnection currConn = null;
        ...
        /// <returns></returns>
        public bool CheckDuplicateInUpdate(string Id, string tableName, string fieldName, string value, SqlConnection VcurrConn, SqlTransaction transaction)
        {
            #region Variables
            bool Exist = false;
            SqlConnection currConn = null;
            ...
            try
            {
                ...
                #endregion open connection and transaction
                #region sql statement
                sqlText = @"select distinct " + fieldName + " from " + tableName + " where " + fieldName + "= '" + value + "' and Id<>'" + Id + "' and IsArchive=0";
                SqlCommand _objComm = new SqlCommand();
                _objComm.Connection = currConn;
                _objComm.CommandText = sqlText;
                _objComm.CommandType = CommandType.Text;
        ...
        public bool CheckDuplicateInUpdateWithBranch(string Id, string tableName, string fieldName, string value, int branchId, SqlConnection VcurrConn, SqlTransaction transaction)
        {
            #region Variables
            bool Exist = false;
            SqlConnection currConn = null;
        ...
        public int NextIdWithProduct(string tableName, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
            #region Initializ
            string sqlText = "";
            int nextId = 0;
            ...
            try
            {
                ...
                #endregion open connection and transaction
                #region Save
                sqlText = "select isnull(max(cast(ItemNo as int)),0)+1 FROM  " + tableName + "";
                SqlCommand cmd2 = new SqlCommand(sqlText, currConn);
                cmd2.Transaction = transaction;
                var exeRes = cmd2.ExecuteScalar();
                nextId = Convert.ToInt32(exeRes);
        ...
        public string NextIdWithBranch(string tableName, string BranchId, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Initializ
            string sqlText = "";
            string nextId = "0";
            ...
            try
            {
                ...
                #region Save
                sqlText = " ";
                sqlText += @"Select isnull(max(convert(int,  SUBSTRING(CONVERT(varchar(10), id),CHARINDEX('_', CONVERT(varchar(10)
, id))+1,10))),0) ";
        ...
        public string[] DeleteTableMultiCondition(string tableName, string[] conditionFields, string[] conditionValues, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
        ...
        public string[] DeleteTable(string tableName, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            string[] retResults = new string[6];
            retResults[0] = "Fail";//Success or Fail
        ...
        public string[] DeleteTableByCondition(string tableName, string conditionField, string conditionValue, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            string[] retResults = new string[6];
            retResults[0] = "Fail";//Success or Fail
        ...
        public string NextCode(string tableName, string fieldName, string Branch, string TransDateMMyyS, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
            #region Initializ
            string sqlText = "";
            string retFieldValue = "";
            ...
            try
            {
                ...
                #region Save
                sqlText = "";
                sqlText += @" select  isnull( max(cast(left(right( " + fieldName + ",len(" + fieldName + ")-2),CHARINDEX('/',right( " + fieldName + ",len(" + fieldName + ")-2))-1) as int)),0)+1   Code";
                sqlText += @" from " + tableName + "";
        ...
        public string[] FieldUpdate(string tableName, string updateField, string updatedValue, string conditionField, string conditionValue, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
            #region Variables
            string[] retResults = new string[6];
            retResults[0] = "Fail";//Success or Fail
            ...
            try
            {
                ...
                if (transaction == null) { transaction = currConn.BeginTransaction("UpdateTo" + tableName); }
                #endregion open connection and transaction
                #region Update Settings
                sqlText = "";
                sqlText += "UPDATE " + tableName + " SET ";
        ...
        public string[] FieldUpdateByMultiCondition(string tableName, string updateField, string updatedValue, string[] conditionFields, string[] conditionValues, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
            #region Variables
            string[] retResults = new string[6];
            retResults[0] = "Fail";//Success or Fail
