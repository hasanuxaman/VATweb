...
{
    public class GLBDERequisitionFormDDAL
    {
        ...
        #region Methods
        //==================SelectByMasterId=================
        public List<GLBDERequisitionFormDVM> SelectByMasterId(int Id, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
            string sqlText = "";
            List<GLBDERequisitionFormDVM> VMs = new List<GLBDERequisitionFormDVM>();
            #endregion
            try
            {
                ...
                string[] conditionField = { "fd.GLBDERequisitionId" };
        ...
        //==================SelectById=================
        public List<GLBDERequisitionFormDVM> SelectById(int Id, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
        ...
        ////==================SelectAll=================
        public List<GLBDERequisitionFormDVM> SelectAll(string[] conditionFields = null, string[] conditionValues = null, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
...
SELECT
 fd.Id
,fd.GLBDERequisitionId
,fd.BranchId
,fd.TransactionDateTime
,fd.AccountId
,fd.Amount
,fd.Post
,isnull(fd.IsRejected           ,'0')IsRejected
,isnull(fd.RejectedBy           ,'0')RejectedBy
,isnull(fd.RejectedDate         ,'19000101')RejectedDate
,isnull(fd.RejectedComments     ,'NA')RejectedComments
,fd.Remarks
,acc.Name AccountName
,acc.Code AccountCode
FROM  GLBDERequisitionFormDs fd 
...
";
                ...
                while (dr.Read())
                {
                    vm = new GLBDERequisitionFormDVM();
        ...
        //==================Insert =================
        public string[] Insert(GLBDERequisitionFormDVM vm, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Initializ
            string sqlText = "";
            int Id = 0;
            ...
            retResults[5] = "Insert GLBDERequisitionFormD"; //Method Name
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
            int transResult = 0;
            #endregion
            ...
            try
            {
                ...
                vm.Id = _cDal.NextId(" GLBDERequisitionFormDs", currConn, transaction);
                if (vm != null)
                {
                    #region SqlText
                    sqlText = "  ";
                    sqlText += @" 
INSERT INTO  GLBDERequisitionFormDs(
Id
,GLBDERequisitionId
,TransactionDateTime
,BranchId
...
";
                    ...
                    if (transResult <= 0)
                    {
                        ...
                        throw new ArgumentNullException("Unexpected error to update  GLBDERequisitionFormDs.", "");
                    }
                    #endregion SqlExecution
                }
                else
                {
                    retResults[1] = "This  GLBDERequisitionFormD already used!";
                    throw new ArgumentNullException("Please Input  GLBDERequisitionFormD Value", "");
                }
                #endregion Save
                #region Commit
                if (Vtransaction == null)
        ...
        ////==================AcceptReject =================
        public string[] AcceptReject(GLBDERequisitionFormDVM vm, string[] ids, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            string[] retResults = new string[6];
            retResults[0] = "Fail";//Success or Fail
            ...
            retResults[3] = "sqlText"; //  SQL Query
            retResults[4] = "ex"; //catch ex
            retResults[5] = "Delete GLBDERequisitionFormD"; //Method Name
            int transResult = 0;
            string sqlText = "";
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
            ...
            try
            {
                ...
                if (ids.Length >= 1)
                {
                    ...
                    if (transResult <= 0)
                    {
                        throw new ArgumentNullException(" GLBDERequisitionFormD Delete", vm.Id + " could not Delete.");
                    }
                    #endregion Commit
                ...
                {
                    throw new ArgumentNullException(" GLBDERequisitionFormD Information Delete", "Could not found any item.");
                }
                if (Vtransaction == null && transaction != null)
                {
                    transaction.Commit();
        ...
        ////==================Report=================
        public DataTable Report(GLBDERequisitionFormDVM vm, string[] conditionFields = null, string[] conditionValues = null, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
...
,fd.GLBDERequisitionId
 ,case 
  when fd.IsRejected =1 then 'Decline' 
...
FROM  GLBDERequisitionFormDs fd 
LEFT OUTER JOIN GLAccounts acc ON fd.AccountId = acc.Id
LEFT OUTER JOIN GLBranchs br ON fd.BranchId = br.Id
LEFT OUTER JOIN GLBDERequisitions bde ON bde.Id = fd.GLBDERequisitionId
WHERE  1=1
