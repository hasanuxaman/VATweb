...
{
    public class GLBDERequisitionFormEVM
    {
        ...
        [Display(Name = "Ref. Net Premium")]
        public decimal RefundedNetPremium { get; set; }
        [Display(Name = "BDE (%)")]
        ...
        [Display(Name = "Recovery Amount")]
        public decimal BDERecoveryAmount { get; set; }
